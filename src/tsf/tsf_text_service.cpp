...
constexpr std::wstring_view kFluentSettings24 = fp::svg::kFluentSettings24Path;
constexpr std::wstring_view kFluentEmoji24 = fp::svg::kFluentEmoji24Path;
// Fluent UI System Icons: arrow_clockwise_24_regular.
constexpr std::wstring_view kFluentArrowClockwise24 = fp::svg::kFluentArrowClockwise24Path;
// Fluent UI System Icons: arrow_repeat_all_24_regular.
constexpr std::wstring_view kFluentArrowRepeatAll24 = fp::svg::kFluentArrowRepeatAll24Path;
// Fluent UI System Icons: checkmark_20_regular.
constexpr std::wstring_view kFluentCheckmark20 = fp::svg::kFluentCheckmark20Path;
constexpr std::wstring_view kFluentBoardHeart24 = fp::svg::kFluentBoardHeart24Path;
...
constexpr std::wstring_view kFluentHeart16Filled = fp::svg::kFluentHeart16FilledPath;
